...
var PullToRefresh = function (_Component) {
  ...
  function PullToRefresh() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(PullToRefresh).apply(this, arguments));
  }
  ...
  _createClass(PullToRefresh, [{
    ...
    value: function componentWillMount() {
      this.webPullToRefresh = (0, _WebPullToRefresh2.default)();
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: className + ' ' + prefixCls + '-container', style: style, ref: 'container' },
        _react2.default.createElement(
          'div',
          { ref: 'ptrEl', className: prefixCls + '-ptr' },
          _react2.default.createElement(
            'div',
...
PullToRefresh.propTypes = {
  loadingFunction: _react.PropTypes.func.isRequired, //加载完回调函数，需要 a promise
  icon: _react.PropTypes.element, // 设置下滑时展示的内容
  prefixCls: _react.PropTypes.string, //样式前缀
  loading: _react.PropTypes.element, // 设置加载时展示的内容或样式
  disabled: _react.PropTypes.bool, // 是否禁止向下滑动
  className: _react.PropTypes.string, //自定义class样式
  style: _react.PropTypes.object, // 自定义 style 样式
  contentClassName: _react.PropTypes.string, // 内容自定义 class 样式
  contentStyle: _react.PropTypes.object, // 内容自定义 style 样式
  distanceToRefresh: _react.PropTypes.number, // 设置刷新所需的滑动距离，单位为像素
  resistance: _react.PropTypes.number, // 拖拽阻力系数，设置大于1表示实际拖拽效果变得缓慢，设置小于1，则加速拖拽效果
